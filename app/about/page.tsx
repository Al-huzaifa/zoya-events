...
export default function AboutPage() {
  return (
    <main className="relative min-h-screen text-white overflow-hidden bg-black font-sans selection:bg-[#D4AF37] selection:text-black">
      ...
      <div className="relative z-10">
        ...
        <section className="relative h-[85vh] flex items-center justify-center overflow-hidden border-b border-[#D4AF37]/20">
          <div className="absolute inset-0 z-0">
             <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/80 to-[#050505] z-10" />
             <img 
          ...
          <div className="relative z-20 text-center px-6">
            ...
            <motion.p 
              ...
              className="text-zinc-300 text-sm md:text-lg max-w-3xl mx-auto font-light tracking-[0.3em] uppercase border-t border-[#D4AF37]/30 pt-6 mt-6"
            >
        ...
        ========================================================= */}
        <section className="py-16 border-b border-[#D4AF37]/20 bg-[#0a0a0a]">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            <div className="group">
              <p className="text-[#D4AF37] text-4xl md:text-6xl font-light mb-2">
                <AnimatedCounter to={13} suffix="+" />
              </p>
              <p className="text-zinc-400 uppercase text-[10px] md:text-xs tracking-[0.2em] font-medium">Years of Expertise</p>
            </div>
            <div className="group">
              <p className="text-[#D4AF37] text-4xl md:text-6xl font-light mb-2">
                <AnimatedCounter to={200} suffix="+" />
              </p>
              <p className="text-zinc-400 uppercase text-[10px] md:text-xs tracking-[0.2em] font-medium">Elite Clients</p>
            </div>
            <div className="group">
              <p className="text-[#D4AF37] text-4xl md:text-6xl font-light mb-2">State</p>
              <p className="text-zinc-400 uppercase text-[10px] md:text-xs tracking-[0.2em] font-medium">Wide Presence</p>
            </div>
            <div className="group">
              <p className="text-[#D4AF37] text-4xl md:text-6xl font-light mb-2">
                <AnimatedCounter to={100} suffix="%" />
              </p>
              <p className="text-zinc-400 uppercase text-[10px] md:text-xs tracking-[0.2em] font-medium">In-House Execution</p>
            </div>
          </div>
        </section>
          ...
          <section className="flex flex-col md:flex-row w-full min-h-[60vh] md:min-h-[70vh]">
            <div className="w-full md:w-1/2 bg-[#0f0f0f] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32 order-2 md:order-1">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                ...
                <h2 className="text-3xl md:text-[40px] lg:text-[45px] font-light text-white mb-6 leading-tight">
                  Precision in Planning, <br />
                  <span className="text-[#D4AF37]">Artistry in Execution.</span>
                </h2>
                <p className="text-zinc-200 font-light text-[15px] md:text-[17px] leading-8 mb-6">
                ...
                <p className="text-zinc-200 font-light text-[15px] md:text-[17px] leading-8 mb-10">
            ...
            <div className="w-full md:w-1/2 bg-[#0a0a0a] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                ...
                <ul className="space-y-4 mb-10">
                  <li className="flex items-center gap-4 text-zinc-300 font-light text-[15px]"><span className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></span> Rapid setup for 3-4 month activations.</li>
                  <li className="flex items-center gap-4 text-zinc-300 font-light text-[15px]"><span className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></span> Luxury internal fit-outs including HVAC.</li>
                  <li className="flex items-center gap-4 text-zinc-300 font-light text-[15px]"><span className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></span> Full safety and international compliance.</li>
                </ul>
                <Link href="/sales-office" className="group inline-flex items-center gap-3 px-6 py-3 border border-[#D4AF37] text-white hover:bg-[#D4AF37] hover:text-black transition-all duration-300 text-xs tracking-widest uppercase w-max">
          ...
          <section className="flex flex-col md:flex-row w-full min-h-[60vh] md:min-h-[70vh]">
            <div className="w-full md:w-1/2 bg-[#0f0f0f] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32 order-2 md:order-1">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                ...
                <p className="text-zinc-200 font-light text-[15px] md:text-[17px] leading-8 mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-zinc-400 font-light text-sm">High-strength aluminium alloy.</p>
                  </div>
                  <div>
                    <h5 className="text-[#D4AF37] font-medium mb-1 text-sm uppercase tracking-wider">Quick Installation</h5>
                    <p className="text-zinc-400 font-light text-sm">Rapid deployment anywhere.</p>
                  </div>
                  <div>
                    <h5 className="text-[#D4AF37] font-medium mb-1 text-sm uppercase tracking-wider">Weather Resistant</h5>
                    <p className="text-zinc-400 font-light text-sm">Withstands harsh environments.</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="w-full md:w-1/2 bg-[#0a0a0a] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                ...
                <div className="border-l-2 border-[#D4AF37] pl-6 py-2">
                  <p className="text-xl text-white font-light italic">&quot;Building the extraordinary in hours, not months.&quot;</p>
                </div>
              </motion.div>
            </div>
          </section>
        ...
        ========================================================= */}
        <section className="py-24 px-6 border-t border-[#D4AF37]/20 bg-[#050505]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="group bg-[#0a0a0a] border border-[#D4AF37]/20 p-10 hover:border-[#D4AF37] transition-all duration-500">
                  <div className="h-[2px] w-12 bg-[#D4AF37] mb-6 group-hover:w-24 transition-all duration-500"></div>
                  <h4 className="text-white text-2xl mb-4 font-light group-hover:text-[#D4AF37] transition-colors">{service.title}</h4>
                  <p className="text-zinc-400 font-light text-sm leading-relaxed">{service.desc}</p>
                </div>
              ))}
            </div>
          </div>
...
{/* =========================================================
        ...
        ========================================================= */}
        <section className="relative py-24 px-4 md:px-6 bg-[#050505] border-t border-[#D4AF37]/20 overflow-hidden flex flex-col items-center justify-center min-h-[50vh] md:min-h-[60vh]">
            ...
            <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none px-4">
                <img 
                    ...
                    className="w-[95%] md:w-[80%] lg:w-[60%] max-w-[800px] object-contain opacity-80 md:opacity-100"
                />
            </div>
            
            {/* --- Content Group --- */}
            <div className="relative z-10 w-full text-center flex flex-col items-center justify-center">
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white leading-[1.1] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] mb-8 md:mb-12">
                    Ready to start your <br className="hidden md:block" />
                    <span className="text-[#D4AF37] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
                        Project?
                    </span>
                </h2>
                ...
                <Link 
                    href="/contact" 
                    className="group inline-flex items-center gap-4 px-10 py-4 border-2 border-white text-white hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-500 text-xs md:text-sm font-black tracking-[0.2em] uppercase rounded-sm bg-black/30 backdrop-blur-md shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
                >
                    <span className="w-8 h-8 rounded-full flex items-center justify-center border-2 border-white text-white group-hover:border-[#D4AF37] group-hover:text-[#D4AF37] transition-colors duration-500 bg-transparent">
