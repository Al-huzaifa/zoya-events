...
const salesParticles = Array.from({ length: 30 }).map((_, i) => ({
  id: i,
  initialX: `${Math.random() * 100}vw`,
  endX: `${Math.random() * 110}vw`,
...
export default function SalesOfficePage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#050505] text-white font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
      <GoldenBackground />
      ...
      <section className="relative h-[90vh] md:h-screen flex items-center justify-center text-center px-4 md:px-6 pt-16 md:pt-0 border-b border-[#D4AF37]/20">
        <div className="absolute inset-0 z-0 bg-black">
          ...
          {/* Fallback image if you don't have hero_bg in your new folder */}
          <img src="/images/salesoffice/salesoffice-1.webp" alt="Luxury Background" className="w-full h-full object-cover opacity-40" />
        </div>
        ...
        <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1 }} className="relative z-20 max-w-5xl w-full">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-[110px] font-black uppercase leading-[0.9] mb-6 md:mb-8 tracking-tighter">
            THE ART OF <br/> 
          ...
          <p className="text-zinc-300 text-sm md:text-xl font-light max-w-2xl mx-auto mb-8 md:mb-12 px-2">
      ...
      <section className="py-24 md:py-32 bg-[#080808] relative border-b border-[#D4AF37]/20">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 flex flex-col xl:flex-row gap-16 xl:gap-24 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light uppercase leading-[1.1] tracking-tight mb-8 md:mb-12 max-w-3xl">
            ...
            <div className="flex flex-wrap gap-12 md:gap-20 border-t border-[#D4AF37]/20 pt-10">
              <div>
                <h4 className="text-5xl md:text-6xl font-light text-white mb-2">20+</h4>
                <p className="text-[#D4AF37] text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold">Projects Executed</p>
              </div>
              <div>
                <h4 className="text-5xl md:text-6xl font-light text-white mb-2">6-10 DAYS</h4>
          ...
          <div className="w-full xl:w-1/2 flex flex-col sm:flex-row gap-6 relative">
            <div className="flex-1 p-8 md:p-10 bg-[#111111] border border-white/5 hover:border-[#D4AF37]/50 transition-all rounded-sm flex flex-col justify-center group z-10 shadow-xl">
              <MapPin className="text-[#D4AF37] mb-6 w-10 h-10 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl md:text-2xl font-light mb-4 uppercase tracking-wide text-white">BKC HQ</h3>
              <p className="text-zinc-400 text-sm md:text-base leading-relaxed font-light">
                Strategically based in Pinnacle Corporate Park, managing operations seamlessly across Mumbai & Pune.
              </p>
            </div>
            
            <div className="flex-1 p-8 md:p-10 bg-[#111111] border border-white/5 hover:border-[#D4AF37]/50 transition-all rounded-sm flex flex-col justify-center sm:mt-12 group z-10 shadow-xl">
              <Timer className="text-[#D4AF37] mb-6 w-10 h-10 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl md:text-2xl font-light mb-4 uppercase tracking-wide text-white">Rapid Response</h3>
              <p className="text-zinc-400 text-sm md:text-base leading-relaxed font-light">
      ...
      <section className="flex flex-col w-full bg-black">
        ...
        <div className="flex flex-col md:flex-row w-full min-h-[60vh] md:min-h-[70vh]">
          <div className="w-full md:w-1/2 bg-[#0a0a0a] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32 order-2 md:order-1">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
              <ShieldCheck className="text-[#D4AF37] mb-4 md:mb-6 w-10 h-10 md:w-12 md:h-12" />
              <h3 className="text-3xl md:text-[40px] lg:text-[45px] font-light text-white mb-6 leading-tight">
                Architectural <br />
        ...
        <div className="flex flex-col md:flex-row w-full min-h-[60vh] md:min-h-[70vh]">
          ...
          <div className="w-full md:w-1/2 bg-[#0f0f0f] flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 xl:px-32">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
      ...
      <section className="py-24 lg:py-32 bg-[#030303] border-t border-[#D4AF37]/20">
        <div className="container mx-auto px-4 md:px-8 max-w-[1800px]">
          <div className="text-center mb-16 md:mb-24">
            ...
            <h3 className="text-4xl md:text-6xl lg:text-[80px] font-serif font-light text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
            {projects.map((proj) => (
              <motion.div 
                ...
                className="relative aspect-[4/5] cursor-pointer group bg-black border border-white/10 hover:border-[#D4AF37]/50 rounded-sm overflow-hidden shadow-2xl"
              >
                <img 
                  src={proj.mainSrc} 
                  alt={proj.title} 
      ...
      <AnimatePresence>
        {selectedProject && (
          <motion.div 
            ...
            animate={{ opacity: 1 }} 
            exit={{ opacity: 0 }} 
            className="fixed inset-0 z-[10000] bg-black/95 flex flex-col lg:flex-row backdrop-blur-2xl overflow-y-auto lg:overflow-hidden"
          >
            ...
            <div className="w-full lg:w-2/3 h-[50vh] lg:h-screen relative bg-black shrink-0 flex items-center justify-center">
            ...
            <div className="w-full lg:w-1/3 min-h-[50vh] lg:h-screen p-8 md:p-16 lg:p-24 bg-[#0a0a0a] border-t lg:border-t-0 lg:border-l border-white/10 lg:overflow-y-auto flex flex-col justify-center lg:justify-start">
              <span className="text-[#D4AF37] font-bold text-[10px] md:text-xs uppercase tracking-[0.4em] md:tracking-[0.5em] mb-4 block">
                {selectedProject.category}
              </span>
              <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light text-white mb-6 md:mb-8 leading-tight">
                {selectedProject.title}
              </h3>
              <p className="text-zinc-300 text-sm md:text-lg font-light leading-relaxed mb-10 md:mb-16">
