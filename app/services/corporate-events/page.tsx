...
type StudyType = {
  ...
  longDesc: string;
  image: string;
  stats: { attendees: string; duration: string; location: string };
  result: string;
};
...
export default function CorporateEventsPage() {
  ...
  // --- CASE STUDIES DATA ---
  const caseStudies: StudyType[] = [
    {
      id: 1,
      title: "Fortune 500 Annual Conference",
      description: "A flagship corporate hub transformation with 360-degree projection mapping.",
      ...
      image: "/images/Gemini_Generated_Image_1329e5.png",
      stats: { attendees: "500+", duration: "3 Days", location: "Mumbai Hub" },
      result: "98% satisfaction rating",
    },
    {
      id: 2,
      title: "Historic Airport Launch",
      description: "Managing the high-stakes trial landing ceremony at NMIA Panvel.",
      longDesc: "A historic milestone for Indian aviation. We managed the on-ground infrastructure and VVIP protocols for the first trial landing at Loknete D.B. Patil International Airport (NMIA), transforming the runway into a ceremonial stage.",
      image: "/images/Gemini_Generated_Image_6omx5a6omx5a6omx.jpg",
      stats: { attendees: "VVIP Only", duration: "1 Day", location: "Ulwe, Navi Mumbai" },
      result: "Flawless Historic Execution",
    },
    {
      id: 3,
      title: "Product Launch Gala",
      description: "A high-energy, glamorous evening designed to generate massive media buzz.",
      ...
      image: "/images/product-launch-gala.webp", 
  ...
  return (
    <main className="bg-black text-white min-h-screen selection:bg-[#D4AF37] selection:text-black font-sans relative">
      ...
      <div className="relative z-10">
        ...
        {/* 1. STICKY NAVIGATION (Fixed Z-Index) */}
        {/* Changed z-50 to z-40 to ensure it stays below the modal (which is z-[9999]) */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {caseStudies.map((study) => (
                ...
                >
                  <div className="relative aspect-4/5 overflow-hidden bg-zinc-900 border border-white/10 mb-6 rounded-sm">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                      <div className="bg-[#D4AF37] text-black p-2 inline-block mb-2 shadow-[0_0_20px_rgba(212,175,55,0.4)]">
        ...
        {/* 4. MODAL COMPONENT (FIXED Z-INDEX) */}
        <AnimatePresence>
          {selectedStudy && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              // FIXED: z-[1100] forces it to be the top-most layer on the screen
            ...
            >
              ...
              >
                ...
                <div className="w-full md:w-1/2 p-8 md:p-16 overflow-y-auto">
                  ...
                  <Link 
                    href="/contact"
                    className="inline-flex items-center justify-center gap-4 w-full py-5 bg-[#D4AF37] text-black font-black uppercase tracking-widest text-xs hover:bg-white transition-all shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                  >
                ...
                {/* FIXED: z-[1200] ensures it is absolutely the top element */}
                <button 
                  onClick={() => setSelectedStudy(null)}
                  className="absolute top-4 right-4 z-[1200] p-3 rounded-full bg-black/70 text-white hover:bg-[#D4AF37] hover:text-black border border-white/20 backdrop-blur-md transition-all shadow-lg"
                >
                  <X size={24} />
                </button>
        ...
        {/* 5. SERVICES GRID */}
        <section className="py-24 px-6 border-t border-white/5 bg-zinc-950/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="mb-20">
        ...
        <section className="py-32 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <Award className="mx-auto text-[#D4AF37] mb-8 drop-shadow-[0_0_15px_rgba(212,175,55,0.6)]" size={48} />
